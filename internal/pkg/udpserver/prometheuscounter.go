...
var (
	...
	systacomfortHeatercircuit2ReturnTemperatureCelsius = prometheus.NewGauge(prometheus.GaugeOpts{
...
func registerCounter(registry *prometheus.Registry) {
	...
	registry.MustRegister(
		...
		systacomfortBufferToplayerTemperatureCelsius,
		systacomfortBufferBottomlayerTemperatureCelsius,
        systacomfortCirculationTemperatureCelsius,
		systacomfortHeatercircuit2SupplyTemperatureCelsius,
		systacomfortHeatercircuit2ReturnTemperatureCelsius,
        systacomfortInsideTemperatureCelsius,
		systacomfortInside2TemperatureCelsius,
		...
		systacomfortInsideNormalTargetTemperatureCelsius,
		systacomfortInsideComfortTargetTemperatureCelsius,
		systacomfortInsideReducedTargetTemperatureCelsius,			
        systacomfortHeatCurveRootPointCelsius,
        systacomfortHeatCurveGradientCelsius,
        systacomfortBoilerSupplyUpperLimitCelsius,
		systacomfortReservoirTargetTemperatureCelsius,
		systacomfortInsideNormal2TargetTemperatureCelsius,
		systacomfortInsideComfort2TargetTemperatureCelsius,
		systacomfortInsideReduced2TargetTemperatureCelsius,
        systacomfortBoilerRuntimeSeconds,
        systacomfortBoilerStartsTotal,
		systacomfortSolarOutputKWh,
		systacomfortSolarOutputDayKWh,
		systacomfortSolarOutputTotalKWh,
